...
$id = $_GET['id'];
$query = $con->prepare("SELECT id, nombre, descripcion, precio FROM productos WHERE id = ?");
$query->execute([$id]);
$producto = $query->fetch(PDO::FETCH_ASSOC);

$rutaImagen = "../../images/juegos/" . $id . "/";
$imagen = $rutaImagen . 'principal.jpg'
                    ...
                    <form action="actualiza.php" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div>
                            <?php if (file_exists($imagen)) { ?>
                                <img src="<?php echo $imagen ?>" class="img-thumbnail my-3"><br>
